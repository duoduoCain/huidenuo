...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
    ...
    private static final String regNumberOrZiMu = "[^(a-zA-Z0-9)]";
    ...
    public static String firstUpperCase(String src) {
        StringBuilder result = new StringBuilder();
        result.append(src.substring(0, 1).toUpperCase());
        result.append(src.substring(1));
        return result.toString();
    }
    ...
    public static String getLast4(String src) {
        if (src == null || src.length() <= 4)
            return src;

        return src.substring(src.length() - 4);
    }
